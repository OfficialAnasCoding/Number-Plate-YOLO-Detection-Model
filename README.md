...
There is already a model trained on 50 epochs which you can use. However if you would like to try training your own you can. The models are trained on labelled images from the YOLO_Dataset folder
```bash
